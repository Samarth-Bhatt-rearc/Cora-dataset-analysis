...
The 'cora_data_analysis' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/cora_data_analysis/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] cora_data_analysis_etl` to your workspace.
